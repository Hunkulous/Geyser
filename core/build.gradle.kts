...
val gitCommitName = gitCommit.map { it?.name ?: "0".repeat(40) }.orElse("0".repeat(40))
val gitCommitAbbrev = gitCommit.map { it?.name?.substring(0, 7) ?: "0".repeat(7) }.orElse("0".repeat(7))
